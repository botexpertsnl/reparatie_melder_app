    ...
    <div className="min-h-screen bg-[#040914] text-slate-100 md:grid md:grid-cols-[316px_1fr]">
      <aside className="flex min-h-screen flex-col border-r border-[#1a2436] bg-[#060d19]">
        <div className="border-b border-[#1a2436] px-6 py-5">
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="text-3xl font-semibold leading-none tracking-tight text-white">StatusFlow</div>
                    ...
                    return (
                      <li key={item.href}>
                        <Link
                          href={item.href}
                          className={clsx(
                            "flex items-center gap-3 rounded-xl px-3 py-3 text-2xl font-medium text-slate-300 transition",
      ...
      <div className="flex min-h-screen flex-col">
        <header className="flex h-[69px] items-center justify-end border-b border-[#1a2436] bg-[#101722] px-8">
          <div className="rounded-lg bg-[#182334] px-4 py-2 text-2xl text-slate-400">AutoGarage De Vries</div>
        </header>
